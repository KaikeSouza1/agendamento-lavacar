...
// FUNÇÃO GET QUE ESTAVA FALTANDO
...
export async function PUT(
  ...
  try {
    ...
    // Corrigido para usar os campos atuais do schema
...
export async function DELETE(
  ...
  try {
    ...
    // O onDelete: Cascade no schema do Prisma já cuida disso, 
    // mas manter a exclusão explícita do serviço é uma boa prática para garantir.
